...
public String patients(Model model, 
	...
	Page<Patient> patientList= patientRipository.findByNameContains(motCle,PageRequest.of(page, size));
...
public String delete(Long id, String motCle, String page,String size ) {
	patientRipository.deleteById(id);
	return "redirect:/patients?page="+page+"&motCle="+motCle+"&size="+size;
}

@RequestMapping(path="/formPatient", method=RequestMethod.GET)
...
public String savePatient(Model model,@Valid Patient patient, BindingResult bindingResult) {
	...
	patientRipository.save(patient);
...
Patient p=patientRipository.findById(id).get();
